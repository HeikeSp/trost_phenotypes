...
ssi_experiments_2014 <- rbind(as.data.frame(mpi_fgh_2014_ssi_mean), #67199
                               ...
                               as.data.frame(jki_shelter_2014_ssi_mean), #67518
                               as.data.frame(jki_feld_2014_ssi_mean)) #68015
...
ssi_experiments_2014_melt$culture <- rep( c("67199","67518","68015"), length(lines_2014))
...
write.table(ssi_only_sp, "output/ssi_only_sp_2014_2015.txt", sep="\t", row.names = F)
write.table(control_norm_sy_only_sp, "output/control_norm_sy_only_sp_2014_2015.txt", sep="\t", row.names = F)
```
