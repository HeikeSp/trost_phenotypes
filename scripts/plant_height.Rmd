...
# change level order
plant_height_jki_test_1$cultivar <- factor(plant_height_jki_test_1$cultivar, levels=c("Alegria", "Milva", "Desiree", "Saturna"))
...
plant_height_jki_field_2012_check <- subset(plant_height_jki_field_2012, plant_height_jki_field_2012$cultivar %in% c("Alegria", "Milva", "Desiree", "Saturna"))
# change level order
plant_height_jki_field_2012_check$cultivar <- factor(plant_height_jki_field_2012_check$cultivar, 
...
boxplot(plant_height_mpi_test1_2$height ~ plant_height_mpi_test1_2$treatment * 
        ...
        names=names_treatment_sample_time, ylab="plant height (in cm)", main="MPI test trial 1.2")
...
boxplot(plant_height_mpi_test2$height ~ plant_height_mpi_test2$treatment * 
        ...
        names=names_treatment_sample_time, ylab="plant height (in cm)", main="MPI test trial 2")
...
boxplot(plant_height_mpi_test1_2$height ~ plant_height_mpi_test1_2$treatment * 
        ...
        main="MPI test trial 1", names=names_treatment_sample_time_cultivar)

boxplot(plant_height_mpi_test2$height ~ plant_height_mpi_test2$treatment * 
          plant_height_mpi_test2$timepoint * plant_height_mpi_test2$cultivar, 
        col=cols_treatment_sample_time, las=2, ylab="plant height (in cm)", 
        main="MPI test trial 2", names=names_treatment_sample_time_cultivar)
...
boxplot(plant_height_mpi_test1_2_late$height ~ plant_height_mpi_test1_2_late$treatment * 
        ...
        ylab="plant height (in cm)", main="MPI test trial 1 (only late)", names=names_treatment_cultivar)
...
boxplot(plant_height_mpi_test2_late$height ~ plant_height_mpi_test2_late$treatment * 
        ...
        ylab="plant height (in cm)", main="MPI test trial 2 (only late)", names=names_treatment_cultivar)
legend("topright", legend=levels(plant_height_mpi_test2_late$treatment), fill=cols_treatment)
dev.off()
```
...
boxplot(plant_height_mpi_feld2011_check$height ~ plant_height_mpi_feld2011_check$treatment*
        ...
        names=names_treatment_sample_time_cultivar, las=2)
...
boxplot(plant_height_mpi_feld2011_check_late$height ~ plant_height_mpi_feld2011_check_late$treatment*
        ...
        main="MPI field trial 2011 (only late)", names=names_treatment_cultivar, las=2)

boxplot(plant_height_mpi_feld2012_check$height ~ plant_height_mpi_feld2012_check$treatment* 
          plant_height_mpi_feld2012_check$cultivar, col=cols_treatment, main="MPI field trial 2012", 
        names=names_treatment_cultivar, las=2)
dev.off()
```
