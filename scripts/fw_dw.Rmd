...
# all timepoints
boxplot(plant_height_jki_test_1_melt$value ~ plant_height_jki_test_1_melt$treatment * plant_height_jki_test_1_melt$variable, 
...
boxplot(plant_height_jki_test_1$height_15.07.2011 ~ plant_height_jki_test_1$treatment * plant_height_jki_test_1$cultivar, 
...
# per check cultivar
boxplot(plant_height_jki_field_2012_check_melt$value ~ plant_height_jki_field_2012_check_melt$treatment * plant_height_jki_field_2012_check_melt$cultivar, 
        col=cols_treatment, las=2, ylab="plant height (in cm)", 
