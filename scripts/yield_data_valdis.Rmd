...
# 2015
mpi_fgh_2015_relSY <- func_calc_relSY_valdis(mpi_fgh_2015, plant_lines = lines_2015)
mpi_feld_2015_relSY <- func_calc_relSY_valdis(mpi_feld_2015, plant_lines = lines_2015)
jki_feld_2015_relSY <- func_calc_relSY_valdis(jki_feld_2015, plant_lines = lines_2015)
jki_shelter_2015_relSY <- func_calc_relSY_valdis(jki_shelter_2015, plant_lines = lines_2015)
dethlingen_2015_relSY <- func_calc_relSY_valdis(dethlingen_2015, plant_lines = lines_2015)
