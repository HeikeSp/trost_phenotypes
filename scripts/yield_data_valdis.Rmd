...
# 2014
mpi_fgh_2014_mean_per_line <- ddply(mpi_fgh_2014, c("alias", "treatment"), summarise,  
                                    starch_yield_kg_per_plant = mean(starch_yield_g_per_plant, na.rm = T))
mpi_feld_2014_mean_per_line <- ddply(mpi_feld_2014, c("alias", "treatment"), summarise,  
                                    starch_yield_kg_per_plant = mean(starch_yield_g_per_plant, na.rm = T))
jki_shelter_2014_mean_per_line <- ddply(jki_shelter_2014, c("alias", "treatment"), summarise,  
                                    starch_yield_kg_per_plant = mean(starch_yield_g_per_plant, na.rm = T))
jki_feld_2014_mean_per_line <- ddply(jki_feld_2014, c("alias", "treatment"), summarise,  
                                    starch_yield_kg_per_plant = mean(starch_yield_g_per_plant, na.rm = T))

# 2015
mpi_fgh_2015_mean_per_line <- ddply(mpi_fgh_2015, c("alias", "treatment"), summarise,  
                                    starch_yield_kg_per_plant = mean(starch_yield_g_per_plant, na.rm = T))
mpi_feld_2015_mean_per_line <- ddply(mpi_feld_2015, c("alias", "treatment"), summarise,  
                                    starch_yield_kg_per_plant = mean(starch_yield_g_per_plant, na.rm = T))
jki_shelter_2015_mean_per_line <- ddply(jki_shelter_2015, c("alias", "treatment"), summarise,  
                                    starch_yield_kg_per_plant = mean(starch_yield_g_per_plant, na.rm = T))
jki_feld_2015_mean_per_line <- ddply(jki_feld_2015, c("alias", "treatment"), summarise,  
                                    starch_yield_kg_per_plant = mean(starch_yield_g_per_plant, na.rm = T))
dethlingen_2015_mean_per_line <- ddply(dethlingen_2015, c("alias", "treatment"), summarise,  
                                    starch_yield_kg_per_plant = mean(starch_yield_g_per_plant, na.rm = T))
```
