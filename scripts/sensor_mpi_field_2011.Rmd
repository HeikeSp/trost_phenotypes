---
title: "Sensor Data MPI Field 2011"
...
# load workspace
#load("sensor_mpi_field_2011.RData")
...
meta_sub <- droplevels( subset(meta, meta$Study_ID==44443))
...
# subset after 2011-05-19 and before 2011-08-16
raw_sub <- subset(raw, Date > as.Date("2011-05-19") & Date < as.Date("2011-08-16") )
...
# missing data for:
# from 2011-05-30 to 2011-06-02
# from 2011-06-20 to 2011-06-27
```
...
pdf("figures/sensors_moisture_mpi_field_2011.pdf", width=12, height=8)
...
### save workspace
```{r save workspace}
save.image("sensor_mpi_field_2011.RData")
```
