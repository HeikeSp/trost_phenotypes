---
title: "Sensor Data MPI Field 2012"
...
# load workspace
#load("sensor_mpi_field_2012.RData")
...
### read data table
```{r read data table}
raw <- read.table("data/sensors_logger1_2011_04_12-2012_12_06.txt", header=T, fill=T)

# meta information
meta <- read.table("data/sensors_metadata_logger_sensor_channel.txt", header=T)
meta_sub <- droplevels( subset(meta, meta$Study_ID==56726))
...
# subset after 2012-05-23 and before 2012-07-30
raw_sub <- subset(raw, Date > as.Date("2012-05-23") & Date < as.Date("2012-07-30") )

colnames(raw_sub)

# only the first 36 moisture columns (every second column from 2 to 72)
moisture <- raw_sub[, c(seq(2, 72, by=2))]
...
# missing data for:
# 2012-07-07
# from 2012-07-09 to 2011-07-11
# 2012-07-17
# from 2012-07-21 to 2012-07-23
# from 2012-07-25 to 2012-07-27
```
...
pdf("figures/sensors_moisture_mpi_field_2012.pdf", width=12, height=8)
...
### save workspace
```{r save workspace}
save.image("sensor_mpi_field_2012.RData")
```
