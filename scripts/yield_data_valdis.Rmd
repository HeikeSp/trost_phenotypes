...
# median per line 
mpi_fgh_2014_ssi_median <- func_calc_ssi(mpi_fgh_2014, plant_lines = lines_2014, mpi_fgh_2014_si, keep_replicates = "no")
mpi_feld_2014_ssi_median <- func_calc_ssi(mpi_feld_2014, plant_lines = lines_2014, mpi_feld_2014_si, keep_replicates = "no")
jki_shelter_2014_ssi_median <- func_calc_ssi(jki_shelter_2014, plant_lines = lines_2014, jki_shelter_2014_si, keep_replicates = "no")
jki_feld_2014_ssi_median <- func_calc_ssi(jki_feld_2014, plant_lines = lines_2014, jki_feld_2014_si, keep_replicates = "no")
...
# median per line
mpi_fgh_2015_ssi_median <- func_calc_ssi(mpi_fgh_2015, plant_lines = all_lines_2015, mpi_fgh_2015_si, keep_replicates = "no")
mpi_feld_2015_ssi_median <- func_calc_ssi(mpi_feld_2015, plant_lines = all_lines_2015, mpi_feld_2015_si, keep_replicates = "no")
jki_shelter_2015_ssi_median <- func_calc_ssi(jki_shelter_2015, plant_lines = all_lines_2015, jki_shelter_2015_si, keep_replicates = "no")
jki_feld_2015_ssi_median <- func_calc_ssi(jki_feld_2015, plant_lines = all_lines_2015, jki_feld_2015_si, keep_replicates = "no")
dethlingen_2015_ssi_median <- func_calc_ssi(dethlingen_2015, plant_lines = all_lines_2015, dethlingen_2015_si, keep_replicates = "no")
```
