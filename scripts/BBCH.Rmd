...
source("../libpurzel/func_multiplot_ggplot.R")
```
...
resolution <- 600
tiff("figures/bbch_mpi_test_1_2_late_rank.tiff", width=6*resolution, height=6*resolution, res=resolution)
...
tiff("figures/bbch_mpi_feld_2011_check_late_rank.tiff", width=6*resolution, height=6*resolution, res=resolution)
...
pdf("figures/bbch_rank_pub.pdf", width=12, height=6)
