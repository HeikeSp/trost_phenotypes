...
# test trials
mpi_test_1_2_anova <- func_anova_2fac_ia(mpi_test_1_2, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)
mpi_test_2_anova <- func_anova_2fac_ia(mpi_test_2, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)
jki_test_1_anova <- func_anova_2fac_ia(jki_test_1, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)
jki_test_2_anova <- func_anova_2fac_ia(jki_test_2, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)

test_trials_anova <- func_combine_anova_res(mpi_test_1_2_anova, mpi_test_2_anova, jki_test_1_anova, 
                                            jki_test_2_anova, "f_value", "p_value", "treatment", "cultivar_name")
...
mpi_field_2011_anova <- func_anova_2fac_ia(mpi_field_2011, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)
mpi_field_2012_anova <- func_anova_2fac_ia(mpi_field_2012, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)
jki_field_2012_anova <- func_anova_2fac_ia(jki_field_2012, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)
jki_field_2013_anova <- func_anova_2fac_ia(jki_field_2013, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)

field_trials_anova <- func_combine_anova_res(mpi_field_2011_anova, mpi_field_2012_anova, jki_field_2012_anova, 
                                            jki_field_2013_anova, "f_value", "p_value", "treatment", "cultivar_name")
...
mpi_field_2011_check_anova <- func_anova_2fac_ia(mpi_field_2011_check, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)
mpi_field_2012_check_anova <- func_anova_2fac_ia(mpi_field_2012_check, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)
jki_field_2012_check_anova <- func_anova_2fac_ia(jki_field_2012_check, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)
jki_field_2013_check_anova <- func_anova_2fac_ia(jki_field_2013_check, "starch_yield_g_per_plant", "cultivar_name", "treatment", 0.01)
...
field_trials_check_anova <- func_combine_anova_res(mpi_field_2011_check_anova, mpi_field_2012_check_anova, jki_field_2012_check_anova, 
                                            jki_field_2013_check_anova, "f_value", "p_value", "treatment", "cultivar_name")
...
setEPS()
postscript("../../TROST/Manuskripte/tba/drym_feld_check_cultivars_pub.eps", width=6, height=6, family="Arial")
par(mar=c(2.5, 4.5, 0.5, 0.5))
boxplot(drym_feld_check_pub_melt$drym ~ drym_feld_check_pub_melt$cultivar_name, ylab="DRYM", cex.lab=1.6, cex.axis=1.4, lwd=2)
abline(h=0, col="red", lwd=2)
dev.off()
...
mpi_field_2012[which(mpi_field_2012$cultivar_name=="Alegria" & mpi_field_2012$treatment=="drought stress"),]
...
starch_yield_control_feld_all_early_stress <- rbind(
  aggregate(mpi_field_2011_control$starch_yield_g_per_plant, by=list(mpi_field_2011_control$cultivar_name), median, na.rm=T),
aggregate(mpi_field_2012_control$starch_yield_g_per_plant, by=list(mpi_field_2012_control$cultivar_name), median, na.rm=T),
aggregate(jki_field_2012_control$starch_yield_g_per_plant, by=list(jki_field_2012_control$cultivar_name), median, na.rm=T),
aggregate(jki_field_2013_control$starch_yield_g_per_plant, by=list(jki_field_2013_control$cultivar_name), median, na.rm=T),
...
norm_starch_yield_control_feld_all_early_stress <- c(
  aggregate(mpi_field_2011_control$starch_yield_g_per_plant, by=list(mpi_field_2011_control$cultivar_name), median, na.rm=T)$x/mpi_field_2011_control_starch_yield_median,
aggregate(mpi_field_2012_control$starch_yield_g_per_plant, by=list(mpi_field_2012_control$cultivar_name), median, na.rm=T)$x/mpi_field_2012_control_starch_yield_median,
aggregate(jki_field_2012_control$starch_yield_g_per_plant, by=list(jki_field_2012_control$cultivar_name), median, na.rm=T)$x/jki_field_2012_control_starch_yield_median,
aggregate(jki_field_2013_control$starch_yield_g_per_plant, by=list(jki_field_2013_control$cultivar_name), median, na.rm=T)$x/jki_field_2013_control_starch_yield_median,
