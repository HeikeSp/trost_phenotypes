...
# ONLY CHECK CULTIVARS
plant_height_mpi_feld2011_check <- subset(plant_height_mpi_feld2011, plant_height_mpi_feld2011$cultivar %in% check_names)
# change level order
plant_height_mpi_feld2011_check$cultivar <- factor(plant_height_mpi_feld2011_check$cultivar, check_names_ordered)
...
# ONLY CHECK CULTIVARS 
plant_height_mpi_feld2012_check <- subset(plant_height_mpi_feld2012, plant_height_mpi_feld2012$cultivar %in% check_names)
# change level order
plant_height_mpi_feld2012_check$cultivar <- factor(plant_height_mpi_feld2012_check$cultivar, check_names_ordered)
```
...
par(mar=c(7, 4.1, 4.1, 2.1))
boxplot(plant_height_mpi_feld2011_check$height ~ plant_height_mpi_feld2011_check$treatment, 
        col = cols_treatment, main = "MPI field trial 2011")
boxplot(plant_height_mpi_feld2011_check$height ~ plant_height_mpi_feld2011_check$treatment *
          plant_height_mpi_feld2011_check$timepoint, col = cols_treatment, main = "MPI field trial 2011")

boxplot(plant_height_mpi_feld2012_check$height ~ plant_height_mpi_feld2012_check$treatment, 
        col = cols_treatment, main = "MPI field trial 2012 (only late)")
# boxplot(plant_height_mpi_feld2012_check$height ~ plant_height_mpi_feld2012_check$treatment *
#           plant_height_mpi_feld2012_check$timepoint, col = cols_treatment, main = "MPI field trial 2012")
dev.off()
...
par(mar=c(7, 4.1, 4.1, 2.1))
boxplot(plant_height_mpi_feld2011_check$height ~ plant_height_mpi_feld2011_check$treatment*
          plant_height_mpi_feld2011_check$timepoint * plant_height_mpi_feld2011_check$cultivar, 
        col = cols_treatment_sample_time, main = "MPI field trial 2011", 
        names = names_treatment_sample_time_cultivar_reordered, las = 2)

boxplot(plant_height_mpi_feld2011_check_late$height ~ plant_height_mpi_feld2011_check_late$treatment*
          plant_height_mpi_feld2011_check_late$cultivar, col = cols_treatment, 
        main = "MPI field trial 2011 (only late)", names = names_treatment_cultivar_reordered, las = 2)

boxplot(plant_height_mpi_feld2012_check$height ~ plant_height_mpi_feld2012_check$treatment* 
          plant_height_mpi_feld2012_check$cultivar, col = cols_treatment, main = "MPI field trial 2012", 
...
par(mar=c(7.5, 4.5, 0.5, 0.5))
boxplot(plant_height_mpi_feld2011_check_late$height ~ plant_height_mpi_feld2011_check_late$treatment * 
          plant_height_mpi_feld2011_check_late$cultivar, col = cols_treatment, las = 2, 
...
par(mar=c(7.5, 4.5, 0.5, 0.5))
boxplot(plant_height_mpi_feld2012_check$height ~ plant_height_mpi_feld2012_check$treatment * 
          plant_height_mpi_feld2012_check$cultivar, col = cols_treatment, las = 2, 
        ylab = "plant height (in cm)", names = names_treatment_cultivar_reordered, cex.lab=1.4, cex.axis=1.2)
...
plant_height_mpi_feld_agg <- subset(plant_height_query_result_agg, 
...
plant_height_mpi_feld2011_agg <- subset(plant_height_query_result_agg, 
                                        plant_height_query_result_agg$experiment_id == "44443")
plant_height_mpi_feld2012_agg <- subset(plant_height_query_result_agg, 
                                        plant_height_query_result_agg$experiment_id == "51790")
```
...
plant_height_mpi_feld2011_check_late_anova <- func_anova_2fac_ia(plant_height_mpi_feld2011_check_late, 
                                                                 "height", "cultivar", "treatment", 0.01)
plant_height_mpi_feld2012_check_anova <- func_anova_2fac_ia(plant_height_mpi_feld2012_check, 
                                                            "height", "cultivar", "treatment", 0.01)

# MPI field 2011 early (only check cultivars)
plant_height_mpi_feld2011_check_early_anova <- func_anova_2fac_ia(plant_height_mpi_feld2011_check_early, 
                                                                  "height", "cultivar", "treatment", 0.01)
...
# MPI field 2011 (late)
plant_height_mpi_feld2011_check_late_agg <- ddply(plant_height_mpi_feld2011_check_late, c("cultivar", "treatment"), summarise,
                             N    = sum(!is.na(height)),
                             mean = mean(height, na.rm=TRUE),
                             median = median(height, na.rm=TRUE),
                             sd   = sd(height, na.rm=TRUE),
                             se   = sd / sqrt(N) )
pander(plant_height_mpi_feld2011_check_late_agg)

# MPI field 2012 (late)
plant_height_mpi_feld2012_check_late_agg <- ddply(plant_height_mpi_feld2012_check, c("cultivar", "treatment"), summarise,
                             N    = sum(!is.na(height)),
                             mean = mean(height, na.rm=TRUE),
                             median = median(height, na.rm=TRUE),
                             sd   = sd(height, na.rm=TRUE),
                             se   = sd / sqrt(N) )
pander(plant_height_mpi_feld2012_check_late_agg)
...
plant_height_late_check_agg <- rbind(plant_height_mpi_test1_2_late_agg, #G1
                                     ...
                                     plant_height_mpi_feld2011_check_late_agg, #F1
                                     plant_height_mpi_feld2012_check_late_agg, #F3
...
plant_height_mpi_feld2011_check_late_mean_sd <- func_combine_mean_sd(plant_height_mpi_feld2011_check_late, 
                                                              variable_name = "height")

plant_height_mpi_feld2012_check_late_mean_sd <- func_combine_mean_sd(plant_height_mpi_feld2012_check, 
                                                              variable_name = "height")
...
plant_height_ttest_res <- c(func_ttest_treatment2(plant_height_mpi_test1_2_late, variable_name = "height"), #G1
                            ...
                            func_ttest_treatment2(plant_height_mpi_feld2011_check_late, variable_name = "height"), #F1
                            func_ttest_treatment2(plant_height_mpi_feld2012_check, variable_name = "height"), #F3
...
plant_height_late_check_mean_sd <- rbind(plant_height_mpi_test1_2_late_mean_sd, #G1
                                     ...
                                     plant_height_mpi_feld2011_check_late_mean_sd, #F1
                                     plant_height_mpi_feld2012_check_late_mean_sd, #F3
...
plant_height_late_check_mean_sd$percentage <- plant_height_late_check_mean_sd$mean_drought_stress * 100 /
